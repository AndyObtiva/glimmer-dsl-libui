...
on_should_quit do # Assigned to quit_menu_item automatically (smart default)
  puts 'Bye Bye'
end

preferences_menu_item # Can optionally define an on_clicked listener
about_menu_item # Can optionally define an on_clicked listener
